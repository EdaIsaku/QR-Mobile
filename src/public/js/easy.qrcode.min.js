...
!(function () {
    ...
    (i = (function (a, b) {
        ...
        (f = function (a) {
            ...
            (this.width = b.width || c.width),
                ...
                b.ctx
                    ? (this.__ctx = b.ctx)
                    : ((this.__canvas =
                          this.__document.createElement("canvas")),
        ...
        (f.prototype.__createElement = function (a, b, c) {
            ...
            var d,
                e,
                f = this.__document.createElementNS(
                    "http://www.w3.org/2000/svg",
                    a
                ),
                g = Object.keys(b);
                    ...
                    if (j instanceof h) {
                        if (j.__ctx)
                            for (; j.__ctx.__defs.childNodes.length; )
                                (k =
                                    j.__ctx.__defs.childNodes[0].getAttribute(
                                        "id"
                                    )),
                                    (this.__ids[k] = k),
                                    this.__defs.appendChild(
                                        j.__ctx.__defs.childNodes[0]
                                    );
                        c.setAttribute(
                            i.apply,
                            ...
                            if (null == this.modules[e][f][0])
                                for (var g = -2; g <= 2; g++)
                                    for (var h = -2; h <= 2; h++)
                                        ...
                                        2 == h ||
                                        (0 == g && 0 == h)
                                            ? ((this.modules[e + g][f + h][0] =
                                                  !0),
                                              (this.modules[e + g][f + h][2] =
                                                  a),
                ...
                setupTypeInfo: function (a, b) {
                    for (
                        ...
                        e < 6
                            ...
                            : (this.modules[this.moduleCount - 15 + e][8][0] =
                                  f);
                    }
                    for (var e = 0; e < 15; e++) {
                        var f = !a && 1 == ((d >> e) & 1);
                ...
                t = {
                    ...
                    getBCHTypeInfo: function (a) {
                        for (
                            ...
                            b ^=
                                t.G15 <<
                                (t.getBCHDigit(b) - t.getBCHDigit(t.G15));
                    ...
                    getBCHTypeNumber: function (a) {
                        for (
                            ...
                            b ^=
                                t.G18 <<
                                (t.getBCHDigit(b) - t.getBCHDigit(t.G18));
                        return (a << 12) | b;
                    },
            ...
            multiply: function (a) {
                for (
                    ...
                    for (var e = 0; e < a.getLength(); e++)
                        b[d + e] ^= u.gexp(
                            u.glog(this.get(d)) + u.glog(a.get(e))
                        );
                return new c(b, 0);
            },
            mod: function (a) {
                                  ...
                                  function c(a) {
                                      ...
                                      c !== e && (c = e),
                                          d.logoMaxWidth
                                              ...
                                              : d.logoWidth &&
                                                (c = Math.round(d.logoWidth)),
                                          d.logoMaxHeight
                                              ? (e = Math.round(
                                                    d.logoMaxHeight
                                                ))
                                              : d.logoHeight &&
                                                (e = Math.round(d.logoHeight));
                                      var f, g;
                ...
                : (function () {
                      ...
                      return (
                          (a.prototype.draw = function (a) {
                              ...
                              if (
                                  (g.push("</table>"), g.push("</div>"), b.logo)
                              ) {
                                  var w = new Image();
                                  null != b.crossOrigin &&
                                      (w.crossOrigin = b.crossOrigin),
                                      (w.src = b.logo);
                                  var x = b.width / 3.5,
                                      y = b.height / 3.5;
                                  x != y && (x = y),
